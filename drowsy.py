...
counter = 0
counterLabel = ctk.CTkLabel(master=root, text=counter,
                            height=40, width=120,  text_color="white", fg_color="teal")
...
resetButton = ctk.CTkButton(master=root, text="Reset Counter", command=reset_counter, height=40,
                            width=120,  text_color="white", fg_color="teal")

resetButton.pack()

model = torch.hub.load('ultralytics/yolov5', 'custom',
                       path=r'S:\drowsy\CodeThatObjectDetection-main\CodeThatObjectDetection-main\yolov5\runs\train\exp9\weights\last.pt',
                       force_reload=True)
